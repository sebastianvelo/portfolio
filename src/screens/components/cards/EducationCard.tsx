    ...
    <div className="p-5 h-full flex flex-col">
      <div className="flex items-center mb-4">
        ...
        <div>
          ...
          <p className="text-sm text-secondary-600 dark:text-secondary-300">{props.description}</p>
        </div>
      </div>
      <Badge>{props.start} - {props.end}</Badge>
      <p className="cursor-text mt-4 text-secondary-700 dark:text-secondary-300 flex-grow">
        {props.description}
      </p>
    </div>
  </FlipCardSide>
...
const CardBack = (props: EducationCardProps) => (
  <FlipCardSide>
    <div className="p-5 h-full flex flex-col">
      ...
      <p className="text-sm text-secondary-600 dark:text-secondary-300 mb-2">{props.description}</p>
      <Badge>{props.start} - {props.end}</Badge>
      <p className="cursor-text mt-4 text-secondary-700 dark:text-secondary-300 flex-grow overflow-y-auto [scrollbar-width:thin] [scrollbar-color:#111_#333]">
        {props.description}
      </p>
    </div>
  </FlipCardSide>
