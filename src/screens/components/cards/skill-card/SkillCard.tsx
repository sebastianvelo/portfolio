...
const Tooltip = (props: TooltipProps) => {
    return (
        <div className="absolute top-2 right-2/3 translate-x-full -translate-y-full bg-secondary-800 text-white text-xs px-2 py-1 rounded-md opacity-0 group-hover:opacity-100 transition-all duration-600 pointer-events-none shadow-md whitespace-nowrap z-130">
            {props.children}
        </div>
    )
}
