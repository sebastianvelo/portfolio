...
import { ChevronDownSVG, ChevronUpSVG } from "../../../ui/svg/ChevronSVGs";
...
const LanguageSelector = ({ lang, setLang }: LanguageSelectorProps) => {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      {isOpen && (
        <div className="absolute right-0 z-10 mt-1 w-28 bg-white dark:bg-secondary-900 border border-secondary-200 dark:border-secondary-600 rounded-md shadow-lg dark:shadow-secondary-900/2 animate-in fade-in-0 zoom-in-95 duration-100">
